...
- **Star**: 2,144 · **Fork**: 117 · **开放 issue**: 369 · **贡献者**: 51

## 累计统计

- **发布数**: 48 · **已合并 PR**: 261 · **开放 PR**: 4 · **已关闭 issue**: 323 · **开放 issue**: 46 · **提交数**: 1349

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-11 | 1 | 6 | 2 | 3 | 5 | 14 |
| 90d | 2026-06-12 | 4 | 14 | 3 | 11 | 14 | 59 |
| 360d | 2025-09-15 | 20 | 177 | 4 | 157 | 39 | 481 |

## 代码规模

合计: **46,349** 行代码（覆盖前 5 种语言、共 **291** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Go | 45,551 | 1,237 | 6,645 | 274 |
| Toml | 520 | 47 | 50 | 3 |
| Nix | 188 | 3 | 21 | 11 |
| Dockerfile | 49 | 5 | 8 | 1 |
| Yaml | 22 | 0 | 1 | 2 |
...
_数据快照: `data/card/260910.yml` · 2026-09-10T16:09:43Z._
